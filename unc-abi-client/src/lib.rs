...
use unc_abi_client_impl::{generate_abi_client, read_abi};
pub use unc_abi_client_macros::generate;
...
impl Generator {
    ...
    pub fn generate(self) -> Result<()> {
        ...
        for (abi_path, name) in self.abis {
            ...
            let token_stream = generate_abi_client(unc_abi, contract_name);
